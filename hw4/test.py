...
## Action 數量
n_actions = env.action_space.n  # n_action = 2
...
for i_episode in range(10):
    ...
    for t in range(250):
        ...
        if done:
            print('test = {} , Episode finished after {} timesteps, total rewards {}'.format(i_episode + 1,t+1, rewards))
            break
